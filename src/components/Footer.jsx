import { contactDetails, logos, socialMediaUrl } from '../Details'
...
function Contact() {
  ...
  return (
    <footer id='contact' className='container mx-auto md:flex flex-col justify-between py-2 max-width'>
      <div className='container mx-auto md:flex justify-between py-2'>
        <a href='/'>
      ...
      <hr className='border-1 my-5 text-black-content' />
      ...
      <div className='text-center md:flex justify-between'>
        ...
        <p className='font-semibold text-content text-sm md:text-base'>
          Сделал <span className='bg-clip-text bg-gradient text-transparent'>Семён Денисов</span> на Vite и Кофе
        </p>
      </div>
    </footer>
  )
